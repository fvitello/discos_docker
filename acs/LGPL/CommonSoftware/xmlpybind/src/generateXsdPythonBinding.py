...
def generate_bindings(pkgname, schema_file_list, schema_namespace_list, modpath='..', destdir='lib/python/site-packages'):
...
def main(args, fopen=open):
    ...
    if len(args) >= 3:
        ...
        destdir = 'lib/python/site-packages'
    ...
    try:
        ...
        if flist:
            rv =  generate_bindings(args[0], flist, nslist, modpath, destdir)
        else:
