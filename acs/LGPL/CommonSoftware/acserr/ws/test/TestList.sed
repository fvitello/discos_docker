...
s/openjdk version \"[0-9.]*\" [0-9-]* \(LTS\)*/openjdk version \"xx.x.xxx\"/g
s/OpenJDK Runtime Environment [0-9.]* (build .*)/OpenJDK Runtime Environment XX (build xx.xxx-xx)/g
s/OpenJDK 64-Bit Server VM [0-9.]* (build .*)/OpenJDK 64-Bit Server VM XX (build xx.xxx-xx, ...)/g
