...
class EnvVariableDefaultCheck(unittest.TestCase):
    ...
    def testDefaultValues(self):
        ...
        self.assertEquals(False, 'ACS_LOG_STDOUT' in environ)
        self.assertEquals(False, 'ACS_LOG_CENTRAL' in environ)
...
class StdoutEnvVariableCheck(unittest.TestCase):
    ...
    def testStdoutSetting(self):
        ...
        self.assertEquals(False, 'ACS_LOG_CENTRAL' in environ)
        self.assertEquals(True, 'ACS_LOG_STDOUT' in environ)
...
class CentralEnvVariableCheck(unittest.TestCase):
    ...
    def testStdoutSetting(self):
        ...
        self.assertEquals(False, 'ACS_LOG_STDOUT' in environ)
        self.assertEquals(True, 'ACS_LOG_CENTRAL' in environ)
...
class SeveralLoggerCheck(unittest.TestCase):
    ...
    def testLoggerNamesRequested(self):
        ...
        self.assertEquals(list(Log.logging.Logger.manager.loggerDict.keys()), Log.getLoggerNames())
