	...
	{    
	  public:
	   ...
	   IntParamDef(const string & nameVal, const string & helpVal, const string & promptVal, 
			bool isRequired, shared_ptr< int > defaultVal, shared_ptr< string > strDefault,
			shared_ptr< string > unitsVal, shared_ptr< int > maxVal, shared_ptr< int > minVal, 
	     ...
	     * point to something meaningful, else null.
	     */
	    shared_ptr< string > getStringDefault();
	     ...
	     * point to something meaningful, else null.
	     */
	    shared_ptr< vector<int> > getValidValues();
