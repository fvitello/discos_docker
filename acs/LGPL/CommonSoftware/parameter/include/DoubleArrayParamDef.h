	...
	{    
	  public:
	    ...
	    DoubleArrayParamDef(const string & paramName, const string & helpText, const string & promptText, 
	       bool requiredBoolVal, shared_ptr< string > unitsText, shared_ptr< int > maxLen, shared_ptr< vector < double > > defaultVals);
	     ...
	     */
	    shared_ptr< vector<double> > getDefaultValues();
