	...
	{    
	  public:
		...
		DoubleParamDef(const string & nameVal, const string & helpVal,const  string & promptVal, 
			bool isRequired, shared_ptr< double > defaultVal, shared_ptr< string > strDefault, shared_ptr< string > unitsVal, 
	     ...
	     * point to something meaningful, else null.
	     */
	    shared_ptr< vector< double > > getValidValues();
