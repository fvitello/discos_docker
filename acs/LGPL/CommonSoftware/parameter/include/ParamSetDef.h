...
namespace Parameters {
	...
	{    
		 ...
		 */
		shared_ptr< vector<BoolParamDef> > getBoolParamDefs();

		/**
		* gets all the int param defs for this psetdef
		*/
		shared_ptr< vector<IntParamDef> > getIntParamDefs();

		/**
		* gets all the string param defs for this psetdef
		*/
		shared_ptr< vector<StringParamDef> > getStringParamDefs();

		/**
		* gets all the double param defs for this psetdef
		*/
		shared_ptr< vector<DoubleParamDef> > getDoubleParamDefs();

		/**
		* gets all the int array param defs for this psetdef
		*/
		shared_ptr< vector<IntArrayParamDef> > getIntArrayParamDefs();

		/**
		* gets all the double array param defs for this psetdef
		*/
		shared_ptr< vector<DoubleArrayParamDef> > getDoubleArrayParamDefs();

		/**
		* gets all the string array param defs for this psetdef
		*/
		shared_ptr< vector<StringArrayParamDef> > getStringArrayParamDefs();
