...
void smartptrtest :: parmConstructorTest (void)
{
    ...
    maci::SmartPtr<MockComponent> foo(mcs, true, MockComponent::_duplicate(mcs->getComponent<MockComponent>(cname.c_str())));
...
void smartptrtest :: assnopr_cpyarginvalidTest(void)
{
    ACE_CString cname("Foo");
    maci::SmartPtr<MockComponent> foo;
    maci::SmartPtr<MockComponent> bar((maci::MockContainerServices *) 0, false, MockComponent::_duplicate(mcs->getComponent<MockComponent>(cname.c_str())));
    foo = bar;
}
...
void smartptrtest :: assnopr_constinvalidTest (void)
{
    ACE_CString cname("Foo");
    maci::SmartPtr<MockComponent> foo;
    const maci::SmartPtr<MockComponent> bar((maci::MockContainerServices *) 0, false, MockComponent::_duplicate(mcs->getComponent<MockComponent>(cname.c_str())));
    foo = bar;
}
