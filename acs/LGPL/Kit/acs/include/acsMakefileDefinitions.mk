...
$(CURDIR)/../lib/$1.jar: $(CURDIR)/../idl/$1.idl $($1_IDLprereq) $(subst ../idl/,,$(subst .pidl,.jar,$(subst .idl,.jar,$(foreach idl,$($1_IDLprereq),$(if $(and $(wildcard ../idl/$(idl)),$(filter $(addsuffix .%, $(addprefix ../idl/,$(IDL_LIST) $(ACSERRDEF))),$(idl))),$(CURDIR)/../lib/$(idl), ))  ))) $(if $(filter $1,$(ACSERRDEF)),../idl/$1.xml,)
...
clean_IDL_$1_Python:
	...
	$(AT)$(RM)  ../lib/python/site-packages/{$1_idl.py,$(call pycache,$1_idl)}
...
clean_xmlerr_$1_Python:
	$(AT)$(RM)  ../lib/python/site-packages/$1
	$(AT)$(RM)  ../lib/python/site-packages/$1__POA
	$(AT)$(RM)  ../lib/python/site-packages/{$1Impl.py,$(call pycache,$1Impl)} ../object/$1Impl.py
...
$(LIB)/python/site-packages/$1Impl.py: ../lib/python/site-packages/$1Impl.py
	...
	$(AT)$(PYTHON_ROOT)/bin/python$(PYTHON_VERS) $(PYTHON_ROOT)/lib/python$(PYTHON_VERS)/compileall.py $(PYTHON_OUTPUT) ../lib/python/site-packages 
	$(AT)mkdir -p $(LIB)/python/site-packages/__pycache__
	$(AT)cp ../lib/python/site-packages/$(call pycache,$1Impl) $(LIB)/python/site-packages/$(call pycache,$1Impl)
	$(AT)chmod $(P644) $(LIB)/python/site-packages/$(call pycache,$1Impl)
...
../lib/python/site-packages/$1: ../idl/$1.xml
	...
	-$(AT)cd ../lib/python/site-packages && $(PYTHON_ROOT)/bin/python$(PYTHON_VERS) $(PYTHON_ROOT)/lib/python$(PYTHON_VERS)/compileall.py $(PYTHON_OUTPUT) $1
...
install_python_package_$1:
	...
	$(AT)cd $(LIB)/python/site-packages && $(PYTHON_ROOT)/bin/python$(PYTHON_VERS) $(PYTHON_ROOT)/lib/python$(PYTHON_VERS)/compileall.py $(PYTHON_OUTPUT) $(LIB)/python/site-packages/$1
...
$(LIB)/python/site-packages/$1.py: ../lib/python/site-packages/$1.py
	...
	$(AT)$(PYTHON_ROOT)/bin/python$(PYTHON_VERS) $(PYTHON_ROOT)/lib/python$(PYTHON_VERS)/compileall.py $(PYTHON_OUTPUT) ../lib/python/site-packages
	$(AT)mkdir -p $(LIB)/python/site-packages/__pycache__
	$(AT)cp ../lib/python/site-packages/$(call pycache,$1) $(LIB)/python/site-packages/$(call pycache,$1)
	$(AT)chmod $(P644) $(LIB)/python/site-packages/$(call pycache,$1)
